...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn("rounded-2xl bg-white border border-cream-200 shadow-soft", className)}
      {...props}
    />
  );
}
...
export function CardFooter({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("px-5 py-4 border-t border-cream-200 flex items-center justify-between", className)} {...props} />;
}
